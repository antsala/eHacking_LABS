...
![ZAP open](../img/lab-25-A/202210032010.png)

Esperamos a que termina la actualización. ***ZAP*** está iniciado. Ahora debemos configurar el navegador para que use a ***ZAP*** como proxy, pero eso será más adelante.

Por ahora cerramos ***ZAP***.
